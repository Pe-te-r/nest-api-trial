...
export class TransactionsService {
  ...
  async createCustomerPayment(amount: number, customerAccountId: string, siteAccountId: string, orderId: string) {
  ...
  async payoutToStore(amount: number, siteAccountId: string, storeAccountId: string, orderId: string) {
    const transaction = this.transactionRepository.create({
      type: 'payout_store',
      amount,
  ...
  async payoutToDriver(amount: number, siteAccountId: string, driverAccountId: string, orderId: string) {
    const transaction = this.transactionRepository.create({
      type: 'payout_driver',
      amount,
      fromAccountId: siteAccountId,
